...
// hasn't yet tried the Stacked Desktop app. Mirrors the behavior of
// src/components/DesktopUpsell/DesktopUpsellStartup.tsx:
//
//   - Shown at most 3 times per user (seen_count guard).
//   - Three choices: "Open in Stacked Desktop" (Try), "Not now", "Don't ask again".
...
/// Returns true when Stacked Desktop is a supported platform option.
...
impl DesktopUpsellSelection {
    fn label(self) -> &'static str {
        match self {
            Self::Try => "Open in Stacked Desktop",
            Self::NotNow => "Not now",
...
pub fn render_desktop_upsell_startup(
    ...
    let mut lines: Vec<Line> = vec![
        ...
        Line::from(vec![Span::styled(
            "Same Stacked features with visual diffs, live app",
...
mod tests {
    ...
    fn desktop_upsell_render_smoke() {
        ...
        assert!(rendered.contains("Stacked Desktop") || rendered.contains("visual diffs"));
    }
