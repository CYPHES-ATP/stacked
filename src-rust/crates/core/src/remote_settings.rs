...
// ~/.cyphes/remote-settings.json, and polls every hour in the background.
...
/// On-disk cache structure stored in ~/.cyphes/remote-settings.json.
...
/// Return the ~/.cyphes directory, falling back to the current directory.
