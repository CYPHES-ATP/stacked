// session_storage.rs — JSONL transcript persistence for CYPHES.
//
// File layout:  ~/.cyphes/projects/{base64url(project_root)}/{session_id}.jsonl
//
...
pub struct TranscriptMessage {
    ...
    /// Version of the CYPHES binary, mirrors `MACRO.VERSION`.
    #[serde(default)]
    pub version: String,
...
/// Returns the base projects directory: `~/.cyphes/projects/`.
